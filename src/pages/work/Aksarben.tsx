      ...
      <div className="tile tile-uv-glow p-8">
        <div className="grid md:grid-cols-[300px_1fr] gap-8 md:gap-12">
          ...
          <div className="flex flex-col items-center md:items-start md:border-r md:border-white/10 md:pr-8">
            ...
            <div className="mt-6 relative transition-transform duration-300 hover:scale-105">
              <div className="absolute inset-0 bg-[#d4af37]/20 rounded-lg blur-sm"></div>
              <div className="relative border border-[#d4af37]/30 rounded-lg p-4 bg-gradient-to-br from-[#d4af37]/5 to-transparent backdrop-blur-sm">
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 px-3 py-0.5 bg-[#d4af37] rounded-full text-[10px] font-bold text-gray-900 uppercase tracking-widest shadow-[0_0_20px_rgba(212,175,55,0.5)]">
                  Impact
                </div>
                <p className="text-white text-sm leading-relaxed text-center md:text-left pt-2">
                  Josh fully designed & implemented the complete online web presence growth system powering this project for <span className="font-semibold text-[#d4af37] whitespace-nowrap">10 calls/conversions daily</span>.
                </p>
              </div>
            </div>
          </div>
