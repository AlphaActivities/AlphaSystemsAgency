  ...
  return (
    <div className="container mx-auto px-4 max-w-6xl section-rhythm">
      ...
      >
        ...
        <div className="client-outcome-heading-wrapper relative inline-block">
          <h2 className="client-outcome-heading relative z-10 text-2xl font-bold mb-6 pt-2">Client Outcome</h2>
        </div>
