...
export default function TripleWRentals() {
  ...
  const weeksLive = calculateWeeksLive(projects['triple-w-rentals'].kickoffDate);
      ...
      <div className="mb-12">
        ...
        <div className="flex items-center justify-between gap-4 mb-4">
          <h1 className="text-4xl sm:text-5xl md:text-5xl font-bold leading-tight">
            Triple W<br className="md:hidden" />
            <span className="md:ml-3">Rentals</span>
          </h1>
          <div className="logo-wrapper-locksmith">
            <img
              src="/images/company-logos/Triple W Rentals logo.PNG"
