...
export default function RocketBaller() {
  ...
  const weeksLive = calculateWeeksLive(projects['rocket-baller'].kickoffDate);

  const contributors = [
    {
      name: "Heber",
      roles: ["Full Website Build", "Branding & Design", "Social Content Systems"],
      image: "/images/profile-photos/Heber.jpg",
      ...
      <div className="mb-12">
        ...
        <div className="flex items-center justify-between gap-4 mb-4">
          <h1 className="text-4xl sm:text-5xl md:text-5xl font-bold leading-tight">
            Rocket<br className="md:hidden" />
            <span className="md:ml-3">Baller</span>
          </h1>
