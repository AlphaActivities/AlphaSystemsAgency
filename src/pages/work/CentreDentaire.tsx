...
export default function CentreDentaire() {
  ...
  const weeksLive = calculateWeeksLive(projects['centre-dentaire'].kickoffDate);
      ...
      <div className="mb-12">
        ...
        <div className="flex items-center justify-between gap-4 mb-4">
          <h1 className="text-4xl sm:text-5xl md:text-5xl font-bold leading-tight">
            Centre<br className="md:hidden" />
            <span className="md:ml-3">Dentaire</span>
          </h1>
          <div className="logo-wrapper-locksmith">
            <img
              src="/images/company-logos/Centre Dentaire logo.PNG"
              alt="Centre Dentaire Logo"
